...
<div class="max-w-lg mx-auto -mt-8 mb-12 px-4">
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="first_name" value="{{ old('first_name') }}" required autofocus class="w-full px-4 py-2 rounded-lg border border-slate-200 outline-none transition-all focus:ring-1" onfocus="this.style.borderColor='#fb6300'" onblur="this.style.borderColor=''">
                        @error('first_name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1">Nom</label>
                        <input type="text" name="last_name" value="{{ old('last_name') }}" required class="w-full px-4 py-2 rounded-lg border border-slate-200 outline-none transition-all focus:ring-1" onfocus="this.style.borderColor='#fb6300'" onblur="this.style.borderColor=''">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="country" required class="w-full px-4 py-2 rounded-lg border border-slate-200 outline-none transition-all bg-white focus:ring-1" onfocus="this.style.borderColor='#fb6300'" onblur="this.style.borderColor=''">
                    ...
                    <div>
                        ...
                        <input type="tel" id="phone" name="phone_input" value="{{ old('phone_input') }}" required class="w-full px-4 py-2 rounded-lg border border-slate-200 outline-none transition-all focus:ring-1" placeholder="Ex: 771234567" onfocus="this.style.borderColor='#fb6300'" onblur="this.style.borderColor=''">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="pin" required maxlength="4" class="w-full px-4 py-2 rounded-lg border border-slate-200 outline-none transition-all pr-12 focus:ring-1" onfocus="this.style.borderColor='#fb6300'" onblur="this.style.borderColor=''">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password_confirmation" id="pin_confirmation" required maxlength="4" class="w-full px-4 py-2 rounded-lg border border-slate-200 outline-none transition-all pr-12 focus:ring-1" onfocus="this.style.borderColor='#fb6300'" onblur="this.style.borderColor=''">
            ...
            <button type="submit" class="w-full text-white py-3 rounded-xl font-bold text-lg transition-all mt-6 active:scale-[0.98] border-none" style="background-color: #fb6300;">
                Créer mon compte
            </button>
        </form>
