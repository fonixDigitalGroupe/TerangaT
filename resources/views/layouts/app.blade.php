...
<body class="antialiased bg-[#0f172a] text-slate-900 flex flex-col min-h-screen overflow-x-hidden">
    ...
    <div class="flex-grow flex w-full h-[calc(100vh-64px)]">
        ...
        <aside class="hidden md:flex flex-col w-[100px] lg:w-[120px] shrink-0 text-white py-8 items-center gap-8 overflow-y-auto no-scrollbar" style="background-color: #2d547d;">
            <!-- Accueil -->
            <a href="/" class="flex flex-col items-center group gap-2">
                <div class="w-14 h-14 lg:w-16 lg:h-16 bg-white rounded-full flex items-center justify-center shadow-lg transition-all group-hover:scale-110 group-active:scale-95" style="color: #2d547d;">
